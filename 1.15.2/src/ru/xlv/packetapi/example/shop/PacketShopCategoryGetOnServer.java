...
import ru.xlv.packetapi.server.forge.packet.forge.IPacketCallbackOnServer;
...
public class PacketShopCategoryGetOnServer implements IPacketCallbackOnServer {
    ...
    @Override
    public void readCallbackOnServer(ServerPlayerEntity entityPlayer, ByteBufInputStream bbis, PacketCallbackSender packetCallbackSender) throws IOException {
    ...
    @Override
    public void writeCallbackOnServer(ServerPlayerEntity entityPlayer, ByteBufOutputStream bbos) throws IOException {
